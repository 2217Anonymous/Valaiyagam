...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Meet the architects, engineers, and digital marketing specialists behind Valaiyagam Solution. Explore our leadership and engineering teams.",
  path: "/teams",
  keywords: ["Valaiyagam team", "software engineers", "digital marketing team"],
});
      ...
      <div className="max-w-7xl mx-auto space-y-16 sm:space-y-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 sm:space-y-6">
          ...
          <p className="text-base sm:text-lg text-slate-400">
            The architects, engineers, and visionaries behind {SITE_CONFIG.name}.
          </p>
        </div>
        ...
        {Object.keys(departments).length === 0 ? (
          ...
          Object.entries(departments).map(([dept, members]) => (
            <section key={dept} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {members.map((member) => {
                  const photo = member.documents.find((d) =>
                  ...
                  return (
                    <article key={member.id} className="group relative">
                      ...
                      <div className="relative glass-card p-6 rounded-2xl flex flex-col items-center text-center h-full hover:scale-[1.02] transition-transform duration-300">
                        <div className="w-24 h-24 mb-4 rounded-full bg-slate-800 border-2 border-indigo-500/30 flex items-center justify-center font-bold text-2xl text-indigo-300 overflow-hidden relative">
                          {photo ? (
                            <Image
                              src={photo.url}
